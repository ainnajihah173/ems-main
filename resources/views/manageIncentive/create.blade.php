    ...
    <div class="col-lg-12 order-lg-1">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                ...
                {{-- <div class="card-body"> --}}
                {{-- start form --}}
                <form method="POST" id="form" action="{{ route('user.incentive.store') }}" autocomplete="off"
                    enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">

                    <input type="hidden" name="_method" value="PUT">
                    {{-- <div class="card-header py-2"> --}}
                    <label for="example-color-input" class="form-control-label mb-3">incentive's Detail</label>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group focused">
                                                ...
                                                <input type="text" id="applicant_nationality" class="form-control"
                                                    name="applicant_nationality" placeholder="Job Type"required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group focused">
                                                <label class="form-control-label"
                                                    for="spouse_nationality">Job</label>
                                                <input type="text" id="spouse_nationality" class="form-control"
                                                    name="spouse_nationality" placeholder="Job Type"required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                            ...
                            <div class="tab-pane fade" id="marriage" role="tabpanel" aria-labelledby="marriage_tab">
                                <div class="pl-lg-4">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group focused">
                                                <label class="form-control-label" for="date">Mariage Date<span
                                                        class="small text-danger">*</span></label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group focused">
                                                <label class="form-control-label" for="ref_slot_id">Mariage Time</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group focused">
                                                <label class="form-control-label" for="ref_location_id">Marriage location</label>
