                ...
                <div class="pl-lg-4">
                    <div class="row">
                        ...
                        <div class="col text-right">
                            <button type="button" class="btn btn-primary" onclick="window.location.href='{{route('user.incentive.create')}}'">Add New</button>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-end">
                                    <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                        <a class="text-info me-3" href="{{route('user.incentive.show', ['id' => $data->id])}}"><i class="fas fa-eye fa-lg" aria-hidden="true"></i></a>
