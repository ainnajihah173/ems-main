            ...
            <div class="card-header py-3">
                ...
                <form method="POST" action="{{ route('staff.incentive.update', [$id => $data['id']]) }}"
                    ...
                    <div class="card-header py-2">
                        <label for="example-color-input" class="form-control-label mb-3 fs-5">Incentive Applicant Detail</label>
                        <br><br>
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="applicant_nationality">Job </label>
                                        <input type="text" id="applicant_nationality" class="form-control"
                                            name="applicant_nationality" placeholder="Job Type"
                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="slot">Marriage slot</label>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <label class="form-control-label" for="consultant">Incentive Aprroval Name<span
                                                    class="small text-danger">*</span></label>
