                            ...
                            <tr>
                                ...
                                <td class="align-middle text-end">
                                    <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                        <span class="ml-4">
                                            <a class="text-primary me-3" href="{{route('staff.incentive.edit', ['id' => $data->id])}}"><i class="fas fa-pencil-alt fa-lg" aria-hidden="true"></i></a>
                                        </span>
                                            <span class="ml-4">
                                                <a class="text-success me-3" href="{{route('staff.incentive.show', ['id' => $data->id])}}"><i class="fas fa-eye fa-lg" aria-hidden="true"></i></a>

                                            </span>
                                            <span class="ml-4">
                                                <form method="POST" action="{{ route('staff.incentive.decline', ['id' => $data->id]) }}" style="display: inline;">
                                                    @csrf
                                                    @method('PUT')
